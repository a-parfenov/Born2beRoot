## Проект школы 21
>Его цель - настроить виртуальную машину под управлением Debian и реализовать некоторые базовые вещи, такие как ssh и sudo.
>Скрипт bash, который вы можете увидеть в репозитории, предназначен для отслеживания состояния систем.
